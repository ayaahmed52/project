	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?= $current=='users' ? 'active' : '' ?>"><a href="users.php"><em class="fa fa-calendar">&nbsp;</em> Users</a></li>
			<li><a href="charts.html"><em class="fa fa-bar-chart">&nbsp;</em> Charts</a></li>
			<li><a href="products.php"><em class="fa fa-toggle-off">&nbsp;</em> Products </a></li>
			<li><a class="<?= $current=='product' ? 'active' : '' ?>" href="panels.html"><em class="fa fa-clone">&nbsp;</em> Alerts &amp; Panels</a></li>
